  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-form-item :label="$t('message.当前商铺')" v-if="$store.getters.storename">
          <el-tag class="formItem">{{$store.getters.storename}}</el-tag>
        </el-form-item>
...
export default {
  ...
  data(){
    return{
     options: [{
          value: this.$t('message.当前语言：')+'cn',
          label: this.$t('message.当前语言：')+'cn'
        }, {
          value: this.$t('message.当前语言：')+'ru',
          label: this.$t('message.当前语言：')+'ru'
        }],
        value:''
    }
  },
